...
├── lib/
│   ├── core/               # Tier 1: Foundation (No specialized deps)
│   │   ├── term/           # Colors, cursor, terminal capability
│   │   ├── text/           # Visual width, emoji processing
│   │   └── sh/             # Logging, sudo, dependency checking
│   │
│   ├── ui/                 # Tier 2: Visualization (Reusable widgets)
│   │   ├── layout/         # Core UI rendering, boxes, branding
│   │   ├── widgets/        # Gauges, tables, spinners, viewers
│   │   └── interaction/    # Input, choose, confirm, fuzzy selection
│   │
│   ├── mod/                # Tier 3: Domain Modules (System specific)
│   │   ├── hw/             # CPU, RAM, Sensors, NVIDIA/AMD
│   │   ├── os/             # power, dmidecode, lspci, inxi
│   │   ├── storage/        # smartctl, hdparm, partition monitoring
│   │   └── net/            # network interface metrics and UI
│   │
│   └── app/                # Application Layer
│       ├── dashboard.sh    # Step-based dashboard UI
│       └── runner.sh       # Script execution orchestration
```
├── tests/                  # Test files
