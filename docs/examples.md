...
### Key Components Used
- `lib/core/colors.sh` - Color definitions
- `lib/core/cursor.sh` - Cursor positioning for UI
- `lib/ui/ui.sh` - Progress bars, gauges, styled boxes
- `lib/system/system.sh` - All system metrics
...
### Key Components Used
- `lib/core/colors.sh` - Color output
- `lib/ui/ui.sh` - Table, filter, pager, file picker
...
### Key Components Used
- `lib/core/colors.sh` - Color output
- `lib/ui/ui.sh` - Choose, input, write, confirm
...
### Key Components Used
- `lib/core/colors.sh` - Color output
- `lib/ui/ui.sh` - Format, pager, file picker
...
### Key Components Used
- `lib/core/colors.sh` - Color definitions
- `lib/core/cursor.sh` - Progress UI positioning
- `lib/core/spinner.sh` - Animation during tasks
- `lib/core/logging.sh` - Log file output
- `lib/core/sudo.sh` - Credential management
- `lib/ui/ui.sh` - Styled output
- `lib/dashboard/dashboard.sh` - Step tracking UI
- `lib/dashboard/runner.sh` - Command execution
