...
This directory contains example scripts demonstrating how to use the **Funny Gums** library.

## Core Examples

- **script_template.sh**: A starter template for new scripts.
- **csv_viewer.sh**: Demonstrates `ui_table`, `ui_choose`, and file handling.
