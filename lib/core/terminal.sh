...
# Check if terminal is VTE-based (compatible tier)
# VTE terminals render emojis well but have VS16 width calculation issues
# Returns: 0 if VTE-based, 1 otherwise
_is_vte_terminal() {
